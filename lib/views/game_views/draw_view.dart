      ...
      home: Scaffold(
        appBar:
            AppBar(title: const Text('Drawing Display'), actions: <Widget>[
              ...
              Semantics(label: 'Back button',excludeSemantics: true, child: IconButton(key: const Key('Back'), iconSize: 30, onPressed: () => _popBack(context), icon: const Icon(Icons.arrow_back))),
        ]),
        drawer: Drawer(
