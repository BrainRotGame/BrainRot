...
extension CategoryQueryFilter
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> hasListenersEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
...
extension CategoryQuerySortBy on QueryBuilder<Category, Category, QSortBy> {
  ...
  QueryBuilder<Category, Category, QAfterSortBy> sortByHasListeners() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hasListeners', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> sortByHasListenersDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryQuerySortThenBy
  ...
  QueryBuilder<Category, Category, QAfterSortBy> thenByHasListeners() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hasListeners', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> thenByHasListenersDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hasListeners', Sort.desc);
    });
  }
...
extension CategoryQueryWhereDistinct
  ...
  QueryBuilder<Category, Category, QDistinct> distinctByHasListeners() {
    return QueryBuilder.apply(this, (query) {
